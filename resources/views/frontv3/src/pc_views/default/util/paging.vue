<template>
  <ul class="mo-paging">
    ...
    <li :class="['paging-item', {'paging-item--current' : index === pager}]" v-for="pager in pagers" :key="pager" @click="go(pager)">{{ pager }}</li>
...
<script>
  export default {
    ...
    computed: {
      ...
      //计算总页码
      pages() {
        return Math.ceil(this.sizes / this.limit)
      },
