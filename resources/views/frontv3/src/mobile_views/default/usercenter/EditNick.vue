    ...
    <div class="weui-cells weui-cells_form">
      <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" id="nick-name" v-model="nickName" placeholder="请输入昵称">
        </div>
      </div>
    </div>

    <section class="sec-box">
      <a class="btn-ui btn-register  btn-comm" @click="submitConfirm">确认修改</a>
    </section>
...
<style scoped>
  ...
  .co_head .back {
    width: 0.4533rem;
    height: 0.6533rem;
    background: url('/assets/img/user/arrowL.png') center center no-repeat;
...
<script>
  ...
  export default {
    ...
    methods: {
      submitConfirm() {
        if (this.nickName == '') {
          this.$layer.msg("请先输入昵称!", { time: 2 });
          return;
        }
        dms.LiveApi.editUser({
          'name': this.nickName,
