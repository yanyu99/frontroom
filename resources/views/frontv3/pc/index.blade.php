...
<script type="text/javascript" src="{{$cdn}}/assets/dist_f/vendor.js?v=_{{$webver }}"></script>
<script type="text/javascript" src="{{$cdn}}/assets/dist_f/pc.js?v=_{{$webver }}"></script>
<script type="text/javascript">
    $(function () {
