...
<body style="">
<div class="nice-scroll" style="height: 340px;overflow-y: auto;">
    <table>
        <thead>
        <tr>
            <th style="width: 20%">名次</th>
            <th style="width: 40%">昵称</th>
            <th style="width: 40%">收礼积分</th>
        </tr>
        </thead>
        <tbody>
        {{-- */$i=1;/* --}}
...
<span style="float: right;margin-right: 10px;margin-top: 15px;">总收礼积分：{{$total}}</span>
</body>
