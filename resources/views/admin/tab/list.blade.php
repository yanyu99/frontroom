...
<div class="row">
  <div class="col-sm-12">
    <section class="panel">
      <header class="panel-heading">TAB栏列表</header>
        ...
        <div class="adv-table">
          <div class="clearfix" >
            <div class="btn-group" style='margin-bottom:10px;'>
              <a href="/admin/tabs/edit" class="btn btn-primary">新增</a>
            </div>
          </div>
            ...
            <table class="display table table-bordered table-striped dataTable" id="dynamic-table" aria-describedby="dynamic-table_info">
              ...
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                ...
                <tr>
                  ...
                  <td >{{$list->sort}}</td>
                  <td>
                    <form  style='float:left;margin-right:5px;'  method="post" action="/admin/tabs/del" onsubmit="return confirm('确定删除？');">
                      {{ $ctrl->csrf_field() }}
                      <input  type="hidden" name="id" value="{{$list->
                      id}}">
                      <button class="btn btn-sm btn-danger">删除</button>
                    </form>
                    <a class="btn btn-sm btn-primary" href="/admin/tabs/edit?id={{$list->id}}">编辑</a>
                  </td>
