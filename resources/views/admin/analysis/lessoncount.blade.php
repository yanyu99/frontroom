        ...
        <div class="adv-table">
          ...
          <div class="form-group">
            <div class="controls text-center">
              <button  data-action="/admin/analysis/lessoncount" class="muilt-submit btn btn-primary">查询</button>
              <button  data-action="/admin/analysis/lessoncountexport" class="muilt-submit btn btn-primary">导出</button>
            </div>
          </div>
        </form>
         @if($isParent)
