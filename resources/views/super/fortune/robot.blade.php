            ...
            <div class="row-fluid">
              <div class="span6">
                <div class="dataTables_filter" id="dynamic-table_filter">
                  <form class="form-inline"  method="post" action="/super/fortune/robotadd">
                     <div class="form-group">
                      <span class=" control-label">名称：</span>
                      <input  class="form-control" type="text" name="nick"/> </div>
            ...
            <table class="display table table-bordered table-striped dataTable" id="dynamic-table" aria-describedby="dynamic-table_info">
              ...
              <tbody role="alert" aria-live="polite" aria-relevant="all">
                ...
                <tr>
                  ...
                  <TD>  <form  style='float:left;margin-right:5px;'  method="post" action="/super/fortune/robotdel">
                      {{ $ctrl->csrf_field() }}
