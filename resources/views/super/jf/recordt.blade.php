                                ...
                                <table class="display table table-bordered table-striped dataTable" id="dynamic-table" aria-describedby="dynamic-table_info">
                                    ...
                                    @foreach($lists as $list)
                                        <tr>
                                            ...
                                            <td>{{ $list->user && $list->user->room ? $list->user->room->name : '-'  }}</td>
                                            <td>{{$list->uid}}</td>
                                            ...
                                            <td>{{$list->jf_cur}}</td>
                                            <td>
                                                @if(!empty($list->user) && $list->user->type !=App\Libs\ConstDefine::USERTYPE_ROBOT_ID)
                                                    <a class="btn btn-primary" href="/super/user/edit?id={{$list->uid}}&last={{ urlencode($_SERVER['REQUEST_URI'])  }}">编辑</a>
                                                @else
                                                    -
                                                @endif
                                            </td>
