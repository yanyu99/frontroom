		...
		<section class="panel">
			...
			<div class="panel-body">
				<form class="form-horizontal" method="post" >
						...
						<div class="col-sm-6">
							<div class="img-upload">
								...
								<p id="idIMGTip" class="webuploader-tip">
									<p>
										<input  class="form-control" type="hidden" name="imgurl" id="idIMGInput" @if($edit)value="{{$edit->imgurl}}"@endif/>
										<img id="idIMGShow" @if($edit) src="{{$edit->imgurl}}"@endif alt="" height="100"/></p>
								</p>
							</div>
						</div>
					...
					<div class="form-group">
						<span class="col-sm-2 col-sm-2 control-label">货品描述:*</span>
						<div class="col-sm-4">
							<input  class="form-control" type="text" name="dsc" @if($edit) value="{{$edit->dsc}}" @endif ></div>
					</div>
					<div class="form-group">
						<span class="col-sm-2 col-sm-2 control-label">货品购买所需积分:*</span>
						<div class="col-sm-4">
							<input  class="form-control" type="text" name="price" @if($edit) value="{{$edit->price}}" @endif ></div>
					</div>
					<div class="form-group">
						<span class="col-sm-2 col-sm-2 control-label">发布总库存:*</span>
						<div class="col-sm-4">
							<input  class="form-control" type="text" name="total" @if($edit) value="{{$edit->total}}" @endif ></div>
					</div>
					<div class="form-group">
